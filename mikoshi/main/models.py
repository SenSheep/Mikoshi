...
class Character(models.Model):
    ...
    cyberware = models.JSONField(default=dict, blank=True, null=True)
    weapon = models.JSONField(default=dict, blank=True, null=True)
    vehicle = models.JSONField(default=dict, blank=True, null=True)